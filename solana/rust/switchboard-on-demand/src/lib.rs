...
pub use solana_compat::{solana_program, AccountMeta, Instruction, Pubkey};
pub use SYSTEM_PROGRAM_ID;

// Re-export solana_sdk for client code (when client or client-v3 feature is enabled)
...
cfg_client! {
    ...
    ///
    /// This client-compatible version returns Pubkey type.
    pub fn get_switchboard_on_demand_program_id() -> crate::solana_compat::Pubkey {
